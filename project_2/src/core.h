...
private:
  ...
  uint32_t data_forwarding(uint32_t reg, uint32_t rs_data);
  ...
  PipelineReg<if_id_t>::Ptr  if_id_;
  PipelineReg<id_ex_t>::Ptr  id_ex_;
  PipelineReg<ex_mem_t>::Ptr ex_mem_;
  PipelineReg<mem_wb_t>::Ptr mem_wb_;
